    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (nm != null) {
                ...
                nm.deleteNotificationChannel("stopwatch_channel_old");
                // If the old un-versioned channel exists, delete it too
            ...
            channel.setSound(null, null); // No sound on each update
