                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 sm:gap-4 self-end sm:self-auto ml-auto sm:ml-0">
                            ...
                            <button
                                ...
                                className="text-app-text-muted hover:text-app-accent-error p-1.5 rounded-lg transition-all focus:opacity-100"
                                title="Delete"
                            >
                                <Trash2 size={18} />
                            </button>
                ...
                {completedTodos.map((todo) => (
                    ...
                    >
                        ...
                        <button
                            type="button"
                            onClick={() => deleteTodo(todo.id)}
                            className="text-app-text-muted hover:text-app-accent-error p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-all focus:opacity-100"
                            title="Delete"
                        >
                            <Trash2 size={16} />
                        </button>
