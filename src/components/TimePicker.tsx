...
const TimePicker = memo(({ value, onChange }: TimePickerProps) => {
    ...
    const [tempTime, setTempTime] = useState<TempTime>(parseTime(value));
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent | TouchEvent) => {
            ...
            const clickedInsidePopup = popupRef.current?.contains(event.target as Node);
    ...
    const adjust = (field: 'h' | 'm', amount: number) => {
        setTempTime((prev) => {
                    ...
                    <div className="flex items-center justify-center gap-2 mb-6">
                        ...
                        <div className="flex flex-col items-center">
                            <button
                                type="button"
                                onClick={() => adjust('h', 1)}
                                className="p-1 hover:text-app-primary text-app-text-muted transition-colors"
                            >
                                <ChevronUp size={20} />
                            </button>
                        ...
                        <div className="flex flex-col items-center ml-2">
                            <button
                                ...
                                className={`px-2 py-4 rounded-lg font-bold text-sm transition-colors border ${
                                    tempTime.period === 'AM'
    ...
    return (
        <div className="relative" ref={containerRef}>
            ...
            <button
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border transition-all text-xs sm:text-sm font-medium w-full min-w-[110px] justify-center ${
                    value
