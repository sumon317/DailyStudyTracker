...
const AlarmPermissionModal = memo(({ isOpen, onClose, onOpenSettings }) => {
                ...
                >
                    ...
                    <div className="p-6">
                        <div className="bg-app-bg rounded-xl p-4 mb-6 text-sm text-app-text-main border border-app-border">
                            <p className="mb-3">
                                <strong>Your alarms may not work</strong> when the app is closed because Android requires a special permission.
                            </p>
                            <p className="text-app-text-muted">
                                Please enable <strong>"Alarms & Reminders"</strong> in Settings to ensure your study reminders work reliably.
                            </p>
                        </div>
