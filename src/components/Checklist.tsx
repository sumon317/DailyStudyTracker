...
const ChecklistItem = memo(({ item, onToggle, onUpdateLabel, onRemove }: ChecklistItemProps) => (
    <div
        className={`group flex items-center gap-2 sm:gap-3 rounded-lg border p-3 sm:p-3 transition-colors ${
