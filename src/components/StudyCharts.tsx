...
import type { PieSegmentProps, StudyChartsProps, SubjectProgressBarProps } from '../types';
...
const SubjectProgressBar = memo(({ name, planned, actual, color }: SubjectProgressBarProps) => {
...
const COLORS = ['#6366f1', '#8b5cf6', '#ec4899', '#f97316', '#14b8a6', '#22c55e', '#eab308', '#0ea5e9'];
...
const StudyCharts = memo(({ subjects }: StudyChartsProps) => {
    ...
    const pieData = useMemo(() => {
        ...
        return stats.subjectStats.map((s) => {
            const data: SubjectStat = { ...s, startAngle: currentAngle };
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <div className="flex-1 space-y-2">
                                    ...
                                    <div className="flex justify-between items-center p-2 rounded-lg bg-app-bg/50">
                                        ...
                                        <span
                                            className={`font-semibold ${stats.totalActual >= stats.totalPlanned ? 'text-app-accent-success' : 'text-app-accent-warning'}`}
                                        >
