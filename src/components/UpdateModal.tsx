...
const UpdateModal = memo(({ updateInfo, onClose }: UpdateModalProps) => {
    ...
    return (
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                ...
                >
                    {/* Header */}
                    <div className="bg-gradient-to-r from-app-primary to-app-primary-hover p-6 text-white text-center">
